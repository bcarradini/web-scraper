...
function Spooky(options, callback) {
    ...
    log.error('TEMP: Spooky: 8');

    this.once('ready', function () {
        log.error('TEMP: Spooky: 11');
        this._call('create',
...
Spooky.prototype._spawnChild = function () {
    ...
    log.error('TEMP: Spooky.prototype._spawnChild: 1');
    ...
    log.error('TEMP: Spooky.prototype._spawnChild: 2');

    if (Spooky._instances[options.port]) {
        throw new Error('Already running a server on port ' + options.port);
    }

    log.error('TEMP: Spooky.prototype._spawnChild: 3');

    log.error('TEMP: Spooky.prototype._spawnChild: '+options.command+', '+args);
    ...
    log.error('TEMP: Spooky.prototype._spawnChild: 4');
    ...
    log.error('TEMP: Spooky.prototype._spawnChild: 5');
    ...
    log.error('TEMP: Spooky.prototype._spawnChild: 6');
...
Spooky.create = function (options, callback) {
    log.error('TEMP: Spooky.create: 1');

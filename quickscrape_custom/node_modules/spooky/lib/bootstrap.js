...
Function.prototype.bind = function (oThis) {
    console.log('TEMP: BOOTSTRAP: Function.prototype.bind: 1');
    /* jshint newcap: false, laxbreak: true */
    if (typeof this !== "function") {
        // closest thing possible to the ECMAScript 5 internal IsCallable function
        throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");
    }
    console.log('TEMP: BOOTSTRAP: Function.prototype.bind: 2');
    ...
    console.log('TEMP: BOOTSTRAP: Function.prototype.bind: 3');

    fNOP.prototype = this.prototype;
    fBound.prototype = new fNOP();

    console.log('TEMP: BOOTSTRAP: Function.prototype.bind: 4');
    return fBound;
};
...
console.log('TEMP: BOOTSTRAP: ready!');

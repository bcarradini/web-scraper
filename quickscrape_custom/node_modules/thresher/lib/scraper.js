...
Scraper.prototype.newRenderer = function() {
  log.info('Scraper.prototype.newRenderer: 1');
  var scraper = this;
  var renderer = new scraper.rendererClass();
  log.info('Scraper.prototype.newRenderer: 2');
  renderer.on('renderer.*', function(var1, var2) {
    log.info('Scraper.prototype.newRenderer: *');
    scraper.emit(this.event, var1, var2)
  });
  log.info('Scraper.prototype.newRenderer: 3');
  return renderer;
}
...
Scraper.prototype.scrapeUrl = function(theUrl, node) {
  var scraper = this;
  log.info('Scraper.prototype.scrapeUrl: 1');
  scraper.startTicker();
  ...
  log.info('Scraper.prototype.scrapeUrl: 2');
  renderer.on('renderer.urlRendered', function(theUrl, html) {
    log.info('Scraper.prototype.scrapeUrl: 4');
    ...
    followed = [];
    log.info('Scraper.prototype.scrapeUrl: 5');
    ...
    log.info('Scraper.prototype.scrapeUrl: 6');
  ...
  log.info('Scraper.prototype.scrapeUrl: 3');
}

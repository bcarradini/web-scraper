...
Scraper.prototype.newRenderer = function() {
  log.error('TEMP: Scraper.prototype.newRenderer: 1');
  var scraper = this;
  var renderer = new scraper.rendererClass();
  log.error('TEMP: Scraper.prototype.newRenderer: 2');
  renderer.on('renderer.*', function(var1, var2) {
    log.error('TEMP: Scraper.prototype.newRenderer: *');
    scraper.emit(this.event, var1, var2)
  });
  log.error('TEMP: Scraper.prototype.newRenderer: 3');
  return renderer;
}
...
Scraper.prototype.scrapeUrl = function(theUrl, node) {
  var scraper = this;
  log.error('TEMP: Scraper.prototype.scrapeUrl: 1');
  scraper.startTicker();
  ...
  log.error('TEMP: Scraper.prototype.scrapeUrl: 2');
  renderer.render(theUrl, scraper.actions);
  log.error('TEMP: Scraper.prototype.scrapeUrl: 3');
  scraper.ticker.elongate();
  log.error('TEMP: Scraper.prototype.scrapeUrl: 4');
  log.error('TEMP: Scraper.prototype.scrapeUrl: 5');
  renderer.on('renderer.urlRendered', function(theUrl, html) {
    log.error('TEMP: Scraper.prototype.scrapeUrl: 7');
    ...
    followed = [];
    log.error('TEMP: Scraper.prototype.scrapeUrl: 8');
    ...
    log.error('TEMP: Scraper.prototype.scrapeUrl: 9');
  ...
  log.error('TEMP: Scraper.prototype.scrapeUrl: 6');
}

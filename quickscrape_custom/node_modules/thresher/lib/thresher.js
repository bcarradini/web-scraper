...
Thresher.prototype.scrape = function(scrapeUrl, headless) {
  ...
  log.error('TEMP: Thresher.prototype.scrape: 1');
  ...
  log.error('TEMP: Thresher.prototype.scrape: 2');
  ...
  log.error('TEMP: Thresher.prototype.scrape: 3');
  ...
  log.error('TEMP: Thresher.prototype.scrape: 4');
